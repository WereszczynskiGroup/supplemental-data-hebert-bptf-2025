...
for i in np.arange(1,6):
    ...
    atomicfluct :397-524&!@H= byres out ./NCP_histrmsf/E{i}h2a1.dat
    atomicfluct :749-876&!@H= byres out ./NCP_histrmsf/E{i}h2a2.dat
    go
    quit
    """
...
average = f"""readdata E1h2a1.dat
readdata E2h2a1.dat
readdata E3h2a1.dat
readdata E4h2a1.dat
readdata E5h2a1.dat
avg E1h2a1.dat:2 E2h2a1.dat:2 E3h2a1.dat:2 E4h2a1.dat:2 E5h2a1.dat:2 oversets out Eh2a1.dat
go
quit
"""
...
average = f"""readdata E1h2a2.dat
readdata E2h2a2.dat
readdata E3h2a2.dat
readdata E4h2a2.dat
readdata E5h2a2.dat
avg E1h2a2.dat:2 E2h2a2.dat:2 E3h2a2.dat:2 E4h2a2.dat:2 E5h2a2.dat:2 oversets out Eh2a2.dat
go
quit
"""
