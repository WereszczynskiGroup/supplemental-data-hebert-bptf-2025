...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('resid 295-318 and not name H*')
    residues_3 = u.select_atoms('resid 647-670 and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H4tail1_{i}.dat', conts1, fmt='%d %d', header='Frame Contacts')
    np.savetxt(f'./Hist_contacts/{prefix}H4tail2_{i}.dat', conts2, fmt='%d %d', header='Frame Contacts')
