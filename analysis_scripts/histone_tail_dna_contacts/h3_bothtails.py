...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('resid 999-1034 and not name H*')
    residues_3 = u.select_atoms('resid 1134-1169 and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H3tail1_{i}.dat', conts1, fmt='%d %d', header='Frame Contacts')
    np.savetxt(f'./Hist_contacts/{prefix}H3tail2_{i}.dat', conts2, fmt='%d %d', header='Frame Contacts')
    print(f'H3 evaluation in trajectory {i} written.')
