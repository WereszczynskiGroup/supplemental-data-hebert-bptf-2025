...
residues_h4 = u.select_atoms('(resid 295-318) and not (name H*)')
residues_h3 = u.select_atoms('(resid 999-1034) and not (name H*)')
residues_h2a1 = u.select_atoms('(resid 749-764) and not (name H*)')
residues_h2b1 = u.select_atoms('(resid 877-910) and not (name H*)')
...
np.savetxt(f'./shl_contacts/{prefix}_shl1_-7.0.dat', conts, fmt='%d %d %d %d %d', header='#DNA 1-6,289-294\n#Frame H2A H2B H3 H4 (contacts)')
...
for i in np.arange(7,138,5):
    ...
    conts = contacts_within_cutoff(u, residues_h2a1, residues_h2b1, residues_h3, residues_h4, residues_dna, radius=4.5)
    np.savetxt(f'./shl_contacts/{prefix}_shl1_{shl}.dat', conts, fmt='%d %d %d %d %d', header=f'#DNA {i}-{i+4},{295-i-4}-{295-i}\n#Frame H2A H2B H3 H4 (contacts)')
...
conts = contacts_within_cutoff(u, residues_h2a1, residues_h2b1, residues_h3, residues_h4, residues_dna, radius=4.5)
np.savetxt(f'./shl_contacts/{prefix}_shl1_7.0.dat', conts, fmt='%d %d %d %d %d', header='#DNA 142-153\nFrame H2A H2B H3 H4 (contacts)')
print('Contacts in SHL 7.0 written.')
