...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('(resid 999-1034 or resid 1134-1169) and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H3tails_{i}.dat', conts, fmt='%d %d', header='Frame Contacts')
