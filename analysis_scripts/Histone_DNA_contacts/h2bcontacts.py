...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('(resid 525-646 or resid 877-998) and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H2b_{i}.dat', conts, fmt='%d %d', header='Frame Contacts')
