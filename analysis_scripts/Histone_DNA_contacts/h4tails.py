...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('(resid 295-318 or resid 647-670) and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H4tails_{i}.dat', conts, fmt='%d %d', header='Frame Contacts')
