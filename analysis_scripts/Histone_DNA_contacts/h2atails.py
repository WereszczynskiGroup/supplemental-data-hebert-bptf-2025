...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('(resid 397-412 or resid 749-764) and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H2atails_{i}.dat', conts, fmt='%d %d', header='Frame Contacts')
