...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('(resid 397-524 or resid 749-876) and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H2a_{i}.dat', conts, fmt='%d %d', header='Frame Contacts')
    print('H2a evaluation in trajectory '+str(i)+' written.')
