...
for i in np.arange(1,6):
    ...
    residues_2 = u.select_atoms('(resid 525-558 or resid 877-910) and not name H*')
    ...
    np.savetxt(f'./Hist_contacts/{prefix}H2btails_{i}.dat', conts, fmt='%d %d', header='Frame Contacts')
