...
for i in np.arange(1,6):
    ...
    atomicfluct :295-396&!@H= byres out ./NCP_histrmsf/M{i}h4.1.dat
    atomicfluct :647-748&!@H= byres out ./NCP_histrmsf/M{i}h4.2.dat
    go
    quit
    """
...
average = f"""readdata M1h4.1.dat
readdata M2h4.1.dat
readdata M3h4.1.dat
readdata M4h4.1.dat
readdata M5h4.1.dat
avg M1h4.1.dat:2 M2h4.1.dat:2 M3h4.1.dat:2 M4h4.1.dat:2 M5h4.1.dat:2 oversets out Mh4.1.dat
go
quit
"""
...
average = f"""readdata M1h4.2.dat
readdata M2h4.2.dat
readdata M3h4.2.dat
readdata M4h4.2.dat
readdata M5h4.2.dat
avg M1h4.2.dat:2 M2h4.2.dat:2 M3h4.2.dat:2 M4h4.2.dat:2 M5h4.2.dat:2 oversets out Mh4.2.dat
go
quit
"""
