...
for i in np.arange(1,6):
    ...
    atomicfluct :295-396&!@H= byres out ./NCP_histrmsf/E{i}h4.1.dat
    atomicfluct :647-748&!@H= byres out ./NCP_histrmsf/E{i}h4.2.dat
    go
    quit
    """
...
average = f"""readdata E1h4.1.dat
readdata E2h4.1.dat
readdata E3h4.1.dat
readdata E4h4.1.dat
readdata E5h4.1.dat
avg E1h4.1.dat:2 E2h4.1.dat:2 E3h4.1.dat:2 E4h4.1.dat:2 E5h4.1.dat:2 oversets out Eh4.1.dat
go
quit
"""
...
average = f"""readdata E1h4.2.dat
readdata E2h4.2.dat
readdata E3h4.2.dat
readdata E4h4.2.dat
readdata E5h4.2.dat
avg E1h4.2.dat:2 E2h4.2.dat:2 E3h4.2.dat:2 E4h4.2.dat:2 E5h4.2.dat:2 oversets out Eh4.2.dat
go
quit
"""
